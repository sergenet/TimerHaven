...
<body>
  ...
  <script>
    // Notes code: Save, pin, delete, display notes
...
def main():
    ...
    for lang, _ in LANGS:
        filename = f"{outdir}/notes-{lang}.html"
        with open(filename, "w", encoding="utf-8") as f:
            f.write(html_template(lang, contents[lang]))
